...
def gen_network_glm(input_dir,net_sym_params,house_dict,player,inputs,tot_zip_dict,home_bus_list,PV_area,bat_size,num_duplicates,rewrite_houses,grid):
    ...
    print('Start generating network 2')
    os.chdir(input_dir)
    print('Set dir')
   ...
   #grid = False
    ...
    if grid:
        print('Start reading temperature files')
        ...
        print('Finished reading temperature files')   
    ...
    #key_index=key_index+1
    print('Created dictionary of load for glm')
